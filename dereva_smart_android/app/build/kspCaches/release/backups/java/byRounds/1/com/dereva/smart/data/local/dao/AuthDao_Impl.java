  ...
  public AuthDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`id`,`phoneNumber`,`passwordHash`,`name`,`email`,`targetCategory`,`drivingSchoolId`,`subscriptionStatus`,`subscriptionExpiryDate`,`isPhoneVerified`,`createdAt`,`lastActiveAt`,`lastLoginAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(12, entity.getLastActiveAt());
    ...
    this.__updateAdapterOfUserEntity = new EntityDeletionOrUpdateAdapter<UserEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `users` SET `id` = ?,`phoneNumber` = ?,`passwordHash` = ?,`name` = ?,`email` = ?,`targetCategory` = ?,`drivingSchoolId` = ?,`subscriptionStatus` = ?,`subscriptionExpiryDate` = ?,`isPhoneVerified` = ?,`createdAt` = ?,`lastActiveAt` = ?,`lastLoginAt` = ? WHERE `id` = ?";
      }
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new UserEntity(_tmpId,_tmpPhoneNumber,_tmpPasswordHash,_tmpName,_tmpEmail,_tmpTargetCategory,_tmpDrivingSchoolId,_tmpSubscriptionStatus,_tmpSubscriptionExpiryDate,_tmpIsPhoneVerified,_tmpCreatedAt,_tmpLastActiveAt,_tmpLastLoginAt);
          } else {
            _result = null;
          }
          return _result;

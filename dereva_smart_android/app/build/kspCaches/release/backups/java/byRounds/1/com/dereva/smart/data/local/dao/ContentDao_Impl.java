  ...
  public ContentDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfModuleEntity = new EntityInsertionAdapter<ModuleEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `modules` (`id`,`title`,`description`,`orderIndex`,`licenseCategory`,`thumbnailUrl`,`estimatedDuration`,`lessonCount`,`isDownloaded`,`downloadSize`,`status`,`completionPercentage`,`createdAt`,`updatedAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__insertionAdapterOfLessonEntity = new EntityInsertionAdapter<LessonEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `lessons` (`id`,`moduleId`,`title`,`description`,`orderIndex`,`contentType`,`contentUrl`,`contentText`,`duration`,`isDownloaded`,`isCompleted`,`lastAccessedAt`,`createdAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getLastAccessedAt() == null) {
          ...
          statement.bindLong(12, entity.getLastAccessedAt());
        }
        statement.bindLong(13, entity.getCreatedAt());
      }
    };
      ...
      public List<ModuleEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new ModuleEntity(_tmpId,_tmpTitle,_tmpDescription,_tmpOrderIndex,_tmpLicenseCategory,_tmpThumbnailUrl,_tmpEstimatedDuration,_tmpLessonCount,_tmpIsDownloaded,_tmpDownloadSize,_tmpStatus,_tmpCompletionPercentage,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public ModuleEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new ModuleEntity(_tmpId,_tmpTitle,_tmpDescription,_tmpOrderIndex,_tmpLicenseCategory,_tmpThumbnailUrl,_tmpEstimatedDuration,_tmpLessonCount,_tmpIsDownloaded,_tmpDownloadSize,_tmpStatus,_tmpCompletionPercentage,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<LessonEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _item = new LessonEntity(_tmpId,_tmpModuleId,_tmpTitle,_tmpDescription,_tmpOrderIndex,_tmpContentType,_tmpContentUrl,_tmpContentText,_tmpDuration,_tmpIsDownloaded,_tmpIsCompleted,_tmpLastAccessedAt,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public LessonEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new LessonEntity(_tmpId,_tmpModuleId,_tmpTitle,_tmpDescription,_tmpOrderIndex,_tmpContentType,_tmpContentUrl,_tmpContentText,_tmpDuration,_tmpIsDownloaded,_tmpIsCompleted,_tmpLastAccessedAt,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;

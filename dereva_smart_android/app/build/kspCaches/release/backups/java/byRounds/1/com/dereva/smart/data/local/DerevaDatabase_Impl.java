  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(6) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `modules` (`id` TEXT NOT NULL, `title` TEXT NOT NULL, `description` TEXT NOT NULL, `orderIndex` INTEGER NOT NULL, `licenseCategory` TEXT NOT NULL, `thumbnailUrl` TEXT, `estimatedDuration` INTEGER NOT NULL, `lessonCount` INTEGER NOT NULL, `isDownloaded` INTEGER NOT NULL, `downloadSize` INTEGER NOT NULL, `status` TEXT NOT NULL, `completionPercentage` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, `updatedAt` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'b64144447634e8d6fcc943e7ea853ecb')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsModules = new HashMap<String, TableInfo.Column>(14);
    ...
    }, "b64144447634e8d6fcc943e7ea853ecb", "b659f0981e1a3de68505d9133491b86b");
